...
df=df.drop(['Unnamed: 0','ring-type'],axis=1)
df.head()
...
columns=['cap-shape','cap-color','does-bruise-or-bleed','gill-attachment','gill-color','stem-color','has-ring','habitat','season','class']
